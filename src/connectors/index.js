...
export const injected = new InjectedConnector({
  supportedChainIds: [ChainId.ELA],
});

const elaWalletConnector = new WalletConnectConnector({
...
export const walletConnector = {
  [ChainId.ELA]: elaWalletConnector,
};
...
export const changeNetwork = (chainId) => {
  return new Promise((reslove) => {
    ...
    if (
      ethereum &&
      (ethereum.isMetaMask || ethereum.isCoin98) &&
      networkConf[chainId]
    ) {
      ethereum
        .request({
